...
const SelectTrigger: React.FC<React.ComponentProps<typeof _.Trigger>> = ({
  className,
  children,
  ...props
}) => (
...
const SelectScrollUpButton: React.FC<React.ComponentProps<typeof _.ScrollUpButton>> = ({
  className,
  ...props
}) => (
  <_.ScrollUpButton
...
const SelectScrollDownButton: React.FC<React.ComponentProps<typeof _.ScrollDownButton>> = ({
  className,
  ...props
}) => (
  <_.ScrollDownButton
...
const SelectItem: React.FC<React.ComponentProps<typeof _.Item>> = ({
  className,
  children,
  ...props
}) => (
...
const SelectSeparator: React.FC<React.ComponentProps<typeof _.Separator>> = ({
  className,
  ...props
